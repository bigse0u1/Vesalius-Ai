...
from lerobot.cameras.configs import CameraConfig, Cv2Rotation, ColorMode, Cv2Backends
...
def xlerobot_cameras_config() -> dict[str, CameraConfig]:
    return {
        "head": RealSenseCameraConfig(
            serial_number_or_name="346522061393",
            fps=30,
            width=640,
            height=480,
        ...
        "left_wrist": OpenCVCameraConfig(
            index_or_path="/dev/video6", fps=30, width=320, height=240, rotation=Cv2Rotation.NO_ROTATION, backend=Cv2Backends.V4L2
        ),
        "right_wrist": OpenCVCameraConfig(
            index_or_path="/dev/video8", fps=30, width=320, height=240, rotation=Cv2Rotation.NO_ROTATION, backend=Cv2Backends.V4L2
        ),
        # "left_wrist": OpenCVCameraConfig(
